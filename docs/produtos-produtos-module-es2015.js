...
NotificacaoService.ɵfac = function NotificacaoService_Factory(t) { return new (t || NotificacaoService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_1__["MatSnackBar"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NotificacaoService, [{
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _produtos__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./produtos */ "./src/app/produtos.ts");
...
ProdutosService.ɵfac = function ProdutosService_Factory(t) { return new (t || ProdutosService)(); };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DetalhesProdutoComponent", function() { return DetalhesProdutoComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _produtos_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../../produtos.service */ "./src/app/produtos.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var src_app_notificacao_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/notificacao.service */ "./src/app/notificacao.service.ts");
/* harmony import */ var src_app_carrinho_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/carrinho.service */ "./src/app/carrinho.service.ts");
...
class DetalhesProdutoComponent {
    ...
    adicionarAoCarrinho() {
        ...
        const produto = Object.assign(Object.assign({}, this.produto), { quantidade: this.quantidade });
        this.carrinhoService.adicionarAoCarrinho(produto);
    }
}
DetalhesProdutoComponent.ɵfac = function DetalhesProdutoComponent_Factory(t) { return new (t || DetalhesProdutoComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_produtos_service__WEBPACK_IMPORTED_MODULE_1__["ProdutosService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_notificacao_service__WEBPACK_IMPORTED_MODULE_3__["NotificacaoService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_carrinho_service__WEBPACK_IMPORTED_MODULE_4__["CarrinhoService"])); };
DetalhesProdutoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DetalhesProdutoComponent, selectors: [["app-detalhes-produto"]], decls: 19, vars: 8, consts: [[1, "product__container"], [1, "product-image__container"], ["alt", "", 3, "src"], [1, "product-description__container"], [1, "product__name"], [1, "product__price"], ["type", "number", "min", "1", 3, "ngModel", "ngModelChange"], [1, "product__avaiability"], [3, "click"]], template: function DetalhesProdutoComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](10, "Estoque dispon\u00EDvel");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](11, "label");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](12, " Quantidade: ");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](13, "input", 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DetalhesProdutoComponent_Template_input_ngModelChange_13_listener($event) { return ctx.quantidade = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DetalhesProdutoComponent_Template_button_click_17_listener() { return ctx.adicionarAoCarrinho(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DetalhesProdutoComponent, [{
    ...
    }], function () { return [{ type: _produtos_service__WEBPACK_IMPORTED_MODULE_1__["ProdutosService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }, { type: src_app_notificacao_service__WEBPACK_IMPORTED_MODULE_3__["NotificacaoService"] }, { type: src_app_carrinho_service__WEBPACK_IMPORTED_MODULE_4__["CarrinhoService"] }]; }, null); })();
...
/* harmony import */ var _detalhes_produto_detalhes_produto_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./detalhes-produto/detalhes-produto.component */ "./src/app/produtos/detalhes-produto/detalhes-produto.component.ts");
/* harmony import */ var _produtos_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./produtos.component */ "./src/app/produtos/produtos.component.ts");
...
const routes = [
    { path: '', component: _produtos_component__WEBPACK_IMPORTED_MODULE_3__["ProdutosComponent"] },
    { path: ':id', component: _detalhes_produto_detalhes_produto_component__WEBPACK_IMPORTED_MODULE_2__["DetalhesProdutoComponent"] }
];
...
ProdutosRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function ProdutosRoutingModule_Factory(t) { return new (t || ProdutosRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)],
...
function ProdutosComponent_div_1_Template(rf, ctx) { if (rf & 1) {
...
class ProdutosComponent {
    ...
    ngOnInit() {
        ...
        this.route.queryParamMap.subscribe(params => {
            var _a;
            const descricao = (_a = params.get("descricao")) === null || _a === void 0 ? void 0 : _a.toLowerCase();
            if (descricao) {
...
ProdutosComponent.ɵfac = function ProdutosComponent_Factory(t) { return new (t || ProdutosComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_produtos_service__WEBPACK_IMPORTED_MODULE_1__["ProdutosService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"])); };
ProdutosComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProdutosComponent, selectors: [["app-produtos"]], decls: 2, vars: 1, consts: [[1, "product-list"], ["class", "product-list__card", 4, "ngFor", "ngForOf"], [1, "product-list__card"], [1, "product-list__link", 3, "routerLink"], [3, "src"], [1, "product-item__name"], [1, "product-item__price"], [1, "product-item__price-description"], ["type", "button", 1, "product-item__buy-button"]], template: function ProdutosComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "section", 0);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProdutosComponent, [{
    ...
    }], function () { return [{ type: _produtos_service__WEBPACK_IMPORTED_MODULE_1__["ProdutosService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }]; }, null); })();
...
/* harmony import */ var _produtos_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./produtos.component */ "./src/app/produtos/produtos.component.ts");
/* harmony import */ var _detalhes_produto_detalhes_produto_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./detalhes-produto/detalhes-produto.component */ "./src/app/produtos/detalhes-produto/detalhes-produto.component.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ProdutosModule, { declarations: [_produtos_component__WEBPACK_IMPORTED_MODULE_3__["ProdutosComponent"], _detalhes_produto_detalhes_produto_component__WEBPACK_IMPORTED_MODULE_4__["DetalhesProdutoComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _produtos_routing_module__WEBPACK_IMPORTED_MODULE_2__["ProdutosRoutingModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"]] }); })();
